...
if not st.session_state.listening:
    if st.button("🎤 Start Listening"):
        try:
            ...
            st.warning("⚠️ Microphone not supported in this environment. Please type your input manually:")
            manual_input = st.text_area("📝 Enter your sentence here:", key="manual_input")

            if st.button("📝 Translate Text Input"):
                recognized_text = manual_input.strip()
